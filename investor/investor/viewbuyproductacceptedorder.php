            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select b.*, t.*, t.fullname AS buyer_name, t.mobno AS t_mobno, b.id AS buyproductrequest_id from buyproductrequest b JOIN tblbuyer t ON b.buyer_id = t.id WHERE b.status = 1 AND b.seller_id = '".$_SESSION['aid']."'");
$cnt=1;
