...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select id, fullname, email, mobno from tblfarmer where  email='$uname' && password='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['aid']=$ret['id'];
      $_SESSION['role']= 'farmer';
      $_SESSION['uname'] = ucwords($ret['fullname']);
      $_SESSION['email']=$ret['email'];
      $_SESSION['mobno']=$ret['mobno'];
      $_SESSION['utype'] = 1;
...
<head>
  ...
  <title>AgroLink | Farmers Login</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index.php" class="h3"><b>Farmer Login</b> | AGROLINK</a>
    </div>
    <div class="card-body">
      ...
      <form  method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <a href="register-farmers.php">Register Here</a>
        </div>
      </form>
    </div>
    <!-- /.card-body -->
