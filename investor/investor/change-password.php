...
$query=mysqli_query($con,"select id from tblfarmer where id='$admid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblfarmer set password='$newpassword' where id='$admid'");
...
<head>
  ...
  <title>AgroLink | Farmer Change Password</title>
