...
// Code for Update  Farmer Details
if(isset($_POST['update'])){
$fullname=$_POST['fullname'];
$mobileno=$_POST['mobilenumber'];
$address=$_POST['address'];
$adminid=intval($_SESSION['aid']);
$query=mysqli_query($con,"update tblfarmer set fullname='$fullname', mobno= $mobileno, address = '$address' where id ='$adminid'");
if($query){
...
<?php 
$adminid=intval($_SESSION['aid']);
$query=mysqli_query($con,"select * from tblfarmer where  id='$adminid'");
$cnt=1;
              ...
              <div class="form-group">
               ...
               <input type="text"   name="sadminusername" id="sadminusername" class="form-control" value="<?php echo $result['email'];?>" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter Mobile No"  required value="<?php echo $result['mobno'];?>">
                  </div>
                  <div class="form-group">
