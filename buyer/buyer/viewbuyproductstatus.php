            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select b.*, f.*, f.fullname AS seller_name, f.mobno AS f_mobno from buyproductrequest b JOIN tblfarmer f ON b.seller_id = f.id WHERE b.buyer_id = '".$_SESSION['aid']."'");
$cnt=1;
