              ...
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mx-4 my-2 product-item" data-product-name="<?php echo strtolower($row['name']); ?>">
                        <div class="card d-flex justify-content-left align-items-left" style="width: 20rem; height: 30rem; padding: 8px;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <b>Seller Name: </b><?php echo ucwords($row['f_name']); ?><br>
                                ...
                                <form action="buy-product.php" method="post">
                                    ...
                                    <button type="submit" class="btn btn-success" style="margin-bottom: 10px">Buy Product</button>
                                </form>
                            </div>
                        </div>
                    </div>
