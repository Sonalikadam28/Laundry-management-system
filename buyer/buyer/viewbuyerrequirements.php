...
$query=mysqli_query($con,"delete from tblrequirements where id='$id'");
if($query){
echo "<script>alert('Product Requirement Post details deleted successfully.');</script>";
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Product Requirement Details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
    <div class="row">
        ...
        JOIN tblbuyer b ON r.addedbyno = b.id WHERE r.addedbyno = '".$_SESSION['aid']."'");
...
<a class="btn btn-danger" href="viewbuyerrequirements.php?action=delete&id=<?php echo $row['r_id']; ?>">
