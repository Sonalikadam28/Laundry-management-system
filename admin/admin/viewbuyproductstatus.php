            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select b.*, f.*, f.fullname AS seller_name, f.mobno AS f_mobno, tb.fullname AS buyer_name from buyproductrequest b JOIN tblbuyer tb ON b.buyer_id = tb.id JOIN tblfarmer f ON b.seller_id = f.id");
$cnt=1;
