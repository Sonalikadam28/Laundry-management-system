...
<head>
  ...
  <title>APSOLUTION | Manage Customers</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"SELECT * FROM tblcustomer");
$cnt=1;
...
?>
     ...
     <a  class="btn btn-danger" href="manage-customers.php?action=delete&&id=<?php echo $result['id']; ?>" title="Delete this record" onclick="return confirm('Do you really want to delete this record?');"><i class="fa fa-trash" aria-hidden="true"></i> </a>
     <a  class="btn btn-success" href="#edit-customer.php?said=<?php echo $result['ID'];?>" ><i class="fa fa-edit" aria-hidden="true"></i> </a>
    </th>
                  </tr>
         <?php } ?>
