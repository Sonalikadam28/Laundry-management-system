...
<head>
  ...
  <title>APSOLUTION | Dashboard</title>
        ...
        <?php endif;?>
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <?php $query=mysqli_query($con,"select id from tblcustomer");
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box" style="background-color: #271D2D; color: white">
              <div class="inner">
              <?php $query=mysqli_query($con,"select id from tblitem");
              ...
              <a href="manage-items.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
...
<hr />
          ...
          <!-- <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="manage-investors.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div> -->
          ...
          <!-- <img src="../../admin/images/demo.gif"    width= "100" alt="" srcset="" > -->
